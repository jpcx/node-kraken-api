...
| --- | --- | --- |
| `AlphabetizeNested` | [module:Tools/AlphabetizeNested](https://github.com/jpcx/node-kraken-api/blob/0.1.3/docs/modules/Tools/AlphabetizeNested.md) | Alphabetizes a nested Object. |
| `ParseNested` | [module:Tools/ParseNested](https://github.com/jpcx/node-kraken-api/blob/0.1.3/docs/modules/Tools/ParseNested.md) | Parses a nested Object, Array, Map, or Set according to the rules defined in Settings~Parse |


Source:

*   [node-kraken-api/tools/tools.jsdoc](https://github.com/jpcx/node-kraken-api/blob/0.1.3/tools/tools.jsdoc), [line 7](https://github.com/jpcx/node-kraken-api/blob/0.1.3/tools/tools.jsdoc#L7)
...
*   [node-kraken-api/tools/tools.jsdoc](https://github.com/jpcx/node-kraken-api/blob/0.1.3/tools/tools.jsdoc), [line 15](https://github.com/jpcx/node-kraken-api/blob/0.1.3/tools/tools.jsdoc#L15)
