...
*   [node-kraken-api/api/syncing/loadSync.js](https://github.com/jpcx/node-kraken-api/blob/0.1.3/api/syncing/loadSync.js), [line 281](https://github.com/jpcx/node-kraken-api/blob/0.1.3/api/syncing/loadSync.js#L281)
...
[API\~Syncing~Sync](https://github.com/jpcx/node-kraken-api/blob/0.1.3/docs/namespaces/API/Syncing.md#~Sync)
