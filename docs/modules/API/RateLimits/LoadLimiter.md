...
*   [node-kraken-api/api/rateLimits/loadLimiter.js](https://github.com/jpcx/node-kraken-api/blob/0.1.3/api/rateLimits/loadLimiter.js), [line 77](https://github.com/jpcx/node-kraken-api/blob/0.1.3/api/rateLimits/loadLimiter.js#L77)
...
[API\~RateLimits~Functions](https://github.com/jpcx/node-kraken-api/blob/0.1.3/docs/namespaces/API/RateLimits.md#~Functions)
