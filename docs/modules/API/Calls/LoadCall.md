...
*   [node-kraken-api/api/calls/loadCall.js](https://github.com/jpcx/node-kraken-api/blob/0.1.2/api/calls/loadCall.js), [line 235](https://github.com/jpcx/node-kraken-api/blob/0.1.2/api/calls/loadCall.js#L235)
...
[API\~Calls~Call](https://github.com/jpcx/node-kraken-api/blob/0.1.2/docs/namespaces/API/Calls.md#~Call)
