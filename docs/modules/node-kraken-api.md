...
| --- | --- | --- |
| `settings` | [Settings~Config](https://github.com/jpcx/node-kraken-api/blob/0.1.3/docs/namespaces/Settings.md#~Config) | User-defined settings. |


Source:

*   [node-kraken-api/index.js](https://github.com/jpcx/node-kraken-api/blob/0.1.3/index.js), [line 14](https://github.com/jpcx/node-kraken-api/blob/0.1.3/index.js#L14)
...
[API~Functions](https://github.com/jpcx/node-kraken-api/blob/0.1.3/docs/namespaces/API.md#~Functions)
